...
class MeasurementsControllerTest < ActionController::TestCase
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post :create, measurement: { inserted: @measurement.inserted, name: @measurement.name, position: @measurement.position, ts: @measurement.ts, val: @measurement.val }
    end
  ...
  test "should update measurement" do
    patch :update, id: @measurement, measurement: { inserted: @measurement.inserted, name: @measurement.name, position: @measurement.position, ts: @measurement.ts, val: @measurement.val }
    assert_redirected_to measurement_path(assigns(:measurement))
  end
